...
qiime dada2 denoise-paired \
  ...
  --p-trunc-len-f 0 \
  --p-trunc-len-r 0 \
  --o-table anders-table-trimmed-dada2-no-trunc.qza \
  --o-representative-sequences anders-rep-seqs-trimmed-dada2-no-trunc.qza \
  --o-denoising-stats anders-stats-trimmed-dada2-no-trunc.qza \
  --p-n-threads 0
qiime metadata tabulate \
  --m-input-file anders-stats-trimmed-dada2-no-trunc.qza \
  --o-visualization anders-stats-trimmed-dada2-no-trunc.qzv
qiime feature-table summarize \
  --i-table anders-table-trimmed-dada2-no-trunc.qza \
  --o-visualization anders-table-trimmed-dada2-no-trunc.qzv
qiime feature-table tabulate-seqs \
  --i-data anders-rep-seqs-trimmed-dada2-no-trunc.qza \
  --o-visualization anders-rep-seqs-trimmed-dada2-no-trunc.qzv 
...
qiime feature-classifier classify-sklearn \
  ...
  --i-reads anders-rep-seqs-trimmed-dada2-no-trunc.qza \
  --o-classification anders-taxonomy-trimmed-dada2-no-trunc.qza
qiime metadata tabulate \
  --m-input-file anders-taxonomy-trimmed-dada2-no-trunc.qza \
  --o-visualization anders-taxonomy-trimmed-dada2-no-trunc.qzv
qiime phylogeny align-to-tree-mafft-fasttree \
  --i-sequences anders-rep-seqs-trimmed-dada2-no-trunc.qza \
  --o-alignment anders-aligned-rep-seqs-trimmed-dada2-no-trunc.qza \
  --o-masked-alignment anders-masked-aligned-rep-seqs-trimmed-dada2-no-trunc.qza \
  --o-tree anders-unrooted-tree-trimmed-dada2-no-trunc.qza \
  --o-rooted-tree anders-rooted-tree-trimmed-dada2-no-trunc.qza
qiime taxa barplot \
  --i-table anders-table-trimmed-dada2-no-trunc.qza \
  --i-taxonomy anders-taxonomy-trimmed-dada2-no-trunc.qza \
  --m-metadata-file filenames-anders.tsv \
  --o-visualization anders-taxa-bar-plots-trimmed-dada2-no-trunc.qzv
