...
qiime feature-classifier classify-sklearn \
  ...
  --o-classification taxonomy-dada2-no-trunc-dn-97-nonchimeric-w-borderline-no-minmax-no-len-filter.qza

qiime metadata tabulate \
  --m-input-file taxonomy-dada2-no-trunc-dn-97-nonchimeric-w-borderline-no-minmax-no-len-filter.qza \
  --o-visualization taxonomy-dada2-no-trunc-dn-97-nonchimeric-w-borderline-no-minmax-no-len-filter.qzv

# taxa bar plots
qiime taxa barplot \
  --i-table uchime-dada2-no-trunc-dn-out-97/table-dada2-no-trunc-dn-97-uchime-nonchimeric-w-borderline.qza \
  --i-taxonomy taxonomy-dada2-no-trunc-dn-97-nonchimeric-w-borderline-no-minmax-no-len-filter.qza \
  --m-metadata-file filenames.txt \
  --o-visualization taxa-bar-plots-dada2-no-trunc-dn-97-w-borderline-no-minmax-no-len-filter.qzv
