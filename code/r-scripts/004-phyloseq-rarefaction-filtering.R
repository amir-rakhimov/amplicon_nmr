...
# This script uses the dataframe from the 001-phyloseq-qiime2.R script, and 
# rarefies it by the smallest sample size. If you are working with a 
# subset of hosts (e.g. NMR), you can filter the dataset to include only 
# the subset of samples.
# You can plot a rarefaction curve and filter the dataset, 
# if you need. But we only do rarefaction.
...
# If we're working with NMR only or mice
# custom.levels<-c("NMR")
...
# Import data ####
# If you need only NMR samples, filter the dataset
ps.q.df <-ps.q.agg%>%
