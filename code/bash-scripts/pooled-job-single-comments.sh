...
# We import the fastq files using the metadata file
...
# this command will create a visualization file for quality check
# Open the file and decide the truncation length
qiime demux summarize \
  --i-data pooled-single-end-demux.qza \
  --o-visualization pooled-single-end-demux.qzv
# Remove the sequencing adapters with cutadapt
...
It will truncate the 3prime end. Reads that 
